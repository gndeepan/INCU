...
public class StudentsplashActivity extends AppCompatActivity {
	...
	private Intent stuhome = new Intent();
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.studentsplash);
	...
	private void initializeLogic() {
		lottie1.setAnimation("wolf.json");
		timer = new TimerTask() {
			@Override
			public void run() {
				runOnUiThread(new Runnable() {
					@Override
					public void run() {
						stuhome.setClass(getApplicationContext(), HomeActivity.class);
						startActivity(stuhome);
						finish();
					}
				});
			}
