...
public class StafhomeActivity extends AppCompatActivity {
	...
	private Intent stafftomain = new Intent();
	private Intent stafftobook = new Intent();
	private Intent mainst = new Intent();
	private Intent stfhometochat = new Intent();
	
	@Override
	protected void onCreate(Bundle _savedInstanceState) {
		super.onCreate(_savedInstanceState);
		setContentView(R.layout.stafhome);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear44.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				stafftobook.setClass(getApplicationContext(), BookblockActivity.class);
				startActivity(stafftobook);
			}
		});
		...
		linear45.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				stfhometochat.setClass(getApplicationContext(), ChatActivity.class);
				startActivity(stfhometochat);
			}
		});
		...
		linear52.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				stafftomain.setClass(getApplicationContext(), MainActivity.class);
				startActivity(stafftomain);
				finish();
			}
		});
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.equals("version update")) {
					...
					if (version.equals(app_version)) {
						...
						if (!version.equals(app_version)) {
							final AlertDialog sucess = new AlertDialog.Builder(StafhomeActivity.this).create();
							...
							txt3.setOnClickListener(new View.OnClickListener(){
									...
									ti.setAction(Intent.ACTION_VIEW);
									ti.setData(Uri.parse(update_link));
									startActivity(ti);
								}});
	...
	private void initializeLogic() {
		...
		linear41.setVisibility(View.GONE);
		bgbg.setBackgroundColor(0xFFF4F4FA);
		if (shar.getString("tab5_showed", "").equals("")) {
			final SpannableString spannedDesc = new SpannableString("Menu Drawer");
			TapTargetView.showFor(StafhomeActivity.this, TapTarget.forView(findViewById(R.id.drawer), "Click here", spannedDesc)
			        .cancelable(true)
			        .drawShadow(true)
			        ...
			        .tintTarget(false), new TapTargetView.Listener() {
				      ...
				      public void onTargetClick(TapTargetView view) {
					        ...
					        if (shar.getString("tab6_showed", "").equals("")) {
						final SpannableString spannedDesc = new SpannableString("All book's available");
						TapTargetView.showFor(StafhomeActivity.this, TapTarget.forView(findViewById(R.id.one), "Click here", spannedDesc)
						        .cancelable(true)
						        .drawShadow(true)
						        .titleTextDimen(R.dimen.title_text_size)
						        .tintTarget(false), new TapTargetView.Listener() {
							      ...
							      public void onTargetClick(TapTargetView view) {
								        super.onTargetClick(view);
								        // .. which evidently starts the sequence we defined earlier
								        shar.edit().putString("tab5_showed", "kk").commit();
								shar.edit().putString("tab6_showed", "kk").commit();
