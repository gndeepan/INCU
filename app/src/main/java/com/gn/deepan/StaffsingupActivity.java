...
public class StaffsingupActivity extends AppCompatActivity {
	...
	private Intent singuplogin = new Intent();
	
	@Override
	protected void onCreate(Bundle _savedInstanceState) {
		super.onCreate(_savedInstanceState);
		setContentView(R.layout.staffsingup);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear12.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				fauth.createUserWithEmailAndPassword(edittext1.getText().toString(), edittext2.getText().toString()).addOnCompleteListener(StaffsingupActivity.this, _fauth_create_user_listener);
			}
		});
	...
	private void initializeLogic() {
		...
		edittext3.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/royal_404.ttf"), 0);
	...
	public void onBackPressed() {
		singuplogin.setClass(getApplicationContext(), StaffloginActivity.class);
		startActivity(singuplogin);
		finish();
	}
